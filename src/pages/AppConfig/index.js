        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scrollViewContent}>
                <Animatable.View animation="fadeInUp" style={styles.containerForm}>
                    ...
                    <TouchableOpacity
                        style={styles.button}
                        onPress={() => navigation.navigate('Config4')}
                    >
                        <Text style={styles.buttonText}>Histórico de Acessos</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        style={styles.button}
                        onPress={() => navigation.navigate('Config5')}
                    >
                        <Text style={styles.buttonText}>Associação de Usuários</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        style={styles.button}
                        onPress={() => navigation.navigate('Config6')}
                    >
                        <Text style={styles.buttonText}>Crachá de Usuários</Text>
                    </TouchableOpacity>
                </Animatable.View>
            </ScrollView>
        </SafeAreaView>
